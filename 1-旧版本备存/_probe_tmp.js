...
const TOPBAR_H=50;
const NOTE_COLORS=["#f5e6c8","#f0d690","#e8c5c0","#c5c0e0","#b8c8e0","#a8d0c0","#e8e8ea"];
const LINE_COLORS=["#3a4a6b","#c5483a","#d48840","#4a9a5a","#2a8a9a","#8a5a9a","#7a7a82"];
const MIND_COLORS=["#2a8a9a","#4a9a5a","#8a5a9a","#d48840","#3a4a6b","#c5483a"];
const DEFAULT_NOTE_COLOR="#fde68a";
const DEFAULT_LINE_COLOR="#6e7080";
const RELATION_TYPES={
  related:{label:"关联",color:"#4a9a5a",directional:false,dash:[]},
  supports:{label:"支撑",color:"#3a4a6b",directional:true,dash:[]},
  causes:{label:"导致",color:"#d48840",directional:true,dash:[]},
  contradicts:{label:"反证",color:"#c5483a",directional:true,dash:[6,4]},
  evidence:{label:"证据",color:"#8a5a9a",directional:true,dash:[2,3]},
};
