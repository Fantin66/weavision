...
function render(){
  ...
  if(typeof syncDetailReadDom==="function")syncDetailReadDom(); /* D1: 展开内容阅读层同步 */
...
function drawAnnotation(it,b){
  ...
  if(it.detail){
    /* D1: left-side tab button — distinct color, prominent, sticks out from left edge */
...
/* D1: removed detail modal handlers */

/* D1: Detail state variables (restored after truncation) */
