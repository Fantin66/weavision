...
function applyTheme(){
  ...
  /* D3: refresh logo on theme change */
...
document.addEventListener("keydown",e=>{
  ...
  if(e.key==="e"&&!e.ctrlKey&&!e.metaKey&&!e.altKey){
    ...
    else if(s.type==="fileCard"){console.log("D3 E: calling togglePreviewMorph");togglePreviewMorph(s);}
    return;
  }
  /* D3: Alt+E = delete detail content (mindNode only) */
