...
function styleCfg(){
  ...
  if(s==="paper")return{
    ...
    shadowBlur:dark?19:17, shadowAlpha:dark?.58:.52, /* 纸堆落影 */
    innerGlow:dark?.16:.32, /* 纸面受光 */
    radius:3,
    linkStyle:"pen",
    linkAlpha:.9,
    linkWidth:1.6,          /* 笔触更粗更手写 */
    fontScale:1.05,         /* 手写阅读加大 */
    fontPreset:"handwritten", /* 手写字体（LWGW/Kalam/楷体） */
    outlined:true,
    paper:true,
  };
  if(s==="neumorph")return{id:"neumorph",nodeAlpha:1,nodeBlur:0,borderAlpha:0,borderColor:"transparent",shadowBlur:dark?16:18,shadowAlpha:dark?.55:.5,innerGlow:0,radius:16,linkStyle:"clean",linkAlpha:.3,linkWidth:.8,fontScale:1.02,outlined:false,neumorph:true,fontPreset:"serif"};
  if(s==="minimal")return{
    id:"minimal",
