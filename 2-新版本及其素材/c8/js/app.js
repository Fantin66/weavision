  ...
  try{
    const data={
      projects:state.projects.map(p=>({
        id:p.id,name:p.name,tutorialVersion:p.tutorialVersion||null,
...
function applyStyle(key){
  ...
  if(key==="paper"){state.fontPreset="handwritten";applyFontPreset();}
  else if(key==="neumorph"){state.fontPreset="serif";applyFontPreset();}
  else if(key==="minimal"){state.fontPreset="serif";applyFontPreset();}
  render();saveState();
...
function mountControls(){
  ...
  const MENUS={
    ...
    style:[
      ...
      {icon:"",label:"样式：拟物",key:"",fn:()=>applyStyle("paper")},
    ...
    view:[
      ...
      {sep:true},
      {icon:"",label:"整图导出 PNG",key:"",fn:exportPNG},
      {sep:true},
