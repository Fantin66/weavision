...
function ensureTutorV6(){
  ...
  const note=(text,x,y,color,opt={})=>{const n=addNote(x,y,text,color);n.w=opt.w||n.w;n.h=opt.h||n.h;n.detail=opt.detail||"";n.annotation=opt.annotation||"";return n;};
  ...
  const guide=addFileCard(55,220,playbookId);guide.annotation="可展开预览的教学附件：点击或双击试试看。";guide.detail="打开后可查看完整 Markdown 教程；边缘可选中卡片，内部仍可自然滚动。";
...
function ensureTutorProject(){
  ...
  project.files=[];project.folders=[];project.canvases=[];project.tutorialVersion=TUTORIAL_VERSION;
