...
function styleCfg(){
  ...
  if(s==="neumorph")return{id:"neumorph",nodeAlpha:1,nodeBlur:0,borderAlpha:0,borderColor:"transparent",shadowBlur:dark?16:18,shadowAlpha:dark?.55:.5,innerGlow:0,radius:16,linkStyle:"clean",linkAlpha:.3,linkWidth:.8,fontScale:1.02,outlined:false,neumorph:true};
  if(s==="minimal")return{
    id:"minimal",
