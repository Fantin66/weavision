...
function renderSelBar(sel){
  ...
  /* D4: link selbar — click-to-cycle with graphical icons */
  if(sel.type==="link"||sel.type==="mindLink"){
    ...
    if(!isML) selbar.appendChild(sbtn(ICON.connector,(RELATION_TYPES[sel.relationType]||{}).label||"关联",()=>setLinkRelation(sel)));
  }
...
function updateSelBar(){
  ...
  /* D4: links don't have itemBounds — use midpoint of connected items */
  var b;
  if(sel.type==="link"||sel.type==="mindLink"){
