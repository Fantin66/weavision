...
function applyTheme(){
  ...
  /* D4: refresh logo on theme change */
...
document.addEventListener("keydown",e=>{
  ...
  if(e.key==="e"&&!e.ctrlKey&&!e.metaKey&&!e.altKey){
    ...
    else if(s.type==="fileCard"){console.log("D4 E: calling togglePreviewMorph");togglePreviewMorph(s);}
    return;
  }
  /* D4: Alt+E = delete detail content (mindNode only) */
