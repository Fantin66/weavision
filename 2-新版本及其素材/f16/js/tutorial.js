...
function ensureTutorV6(){
  ...
  const note=(text,x,y,color,opt={})=>{const n=addNote(x,y,text,color);n.w=opt.w||n.w;n.h=opt.h||n.h;n.annotation=opt.annotation||"";return n; /* E5: note.detail removed */};
  ...
  const guide=addFileCard(55,220,playbookId);guide.annotation="可展开预览的教学附件：点击或双击试试看。";/* E5: guide.detail removed — fileCard no longer supports detail */
